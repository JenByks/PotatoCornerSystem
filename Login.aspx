<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PotatoCorner.Login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-container">
            ...
            <div class="register-link">
                <asp:LinkButton ID="lnkRegister" runat="server" Text="Register" OnClick="lnkRegister_Click" ForeColor="White"></asp:LinkButton>
            </div>
        </div>
    </form>
</body>
