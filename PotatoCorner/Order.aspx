<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="PotCor.Order" MaintainScrollPositionOnPostback="true" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stock-badge { background: linear-gradient(135deg, #f5c800 0%, #e6b800 100%); color: #333; padding: 6px 14px; border-radius: 20px; font-size: 12px; font-weight: 700; box-shadow: 0 2px 6px rgba(245,200,0,0.3); }
                ...
                <div class="product-grid">
                    ...
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <div class="stock-badge">Stock: <asp:Label ID="lblStockFries" runat="server" Text="50"></asp:Label></div>
                        </div>
                    ...
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <div class="stock-badge">Stock: <asp:Label ID="lblStockChicken" runat="server" Text="50"></asp:Label></div>
                        </div>
                        <div class="product-body">
                            <div class="sizes-section">
                                <div class="section-label">Size</div>
                    ...
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <div class="stock-badge">Stock: <asp:Label ID="lblStockLoopys" runat="server" Text="50"></asp:Label></div>
                        </div>
                        <div class="product-body">
                            <div class="sizes-section">
                                <div class="section-label">Size</div>
            ...
            <div class="right-panel">
                            ...
                            <ItemTemplate>
                                <div class="cart-item">
                                    <div class="cart-item-header">
                                        ...
                                        <asp:Button runat="server" Text="×" CssClass="btn-remove" CommandName="Remove" CommandArgument='<%# Container.ItemIndex %>' CausesValidation="false" />
                                    </div>
                                    <div class="cart-item-details">
                                        <%# Eval("Size") %> | <%# Eval("Flavor") %> | Qty: <%# Eval("Qty") %><br />
                                        PHP <%# Eval("LineTotal", "{0:0.00}") %>
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                        <div class="cart-totals">
                            <div class="total-row"><span>Subtotal</span><span>PHP <asp:Label ID="lblSubtotal" runat="server" Text="0.00"></asp:Label></span></div>
                            <div class="total-row"><span>Discount</span><span>-PHP <asp:Label ID="lblDiscount" runat="server" Text="0.00"></asp:Label></span></div>
                            <div class="total-row"><span>Delivery</span><span>+PHP <asp:Label ID="lblDeliveryFee" runat="server" Text="0.00"></asp:Label></span></div>
                            <div class="total-row grand"><span>TOTAL</span><span>PHP <asp:Label ID="lblTotal" runat="server" Text="0.00"></asp:Label></span></div>
                        </div>
                    </asp:Panel>
                </div>
                ...
                <div class="delivery-section">
                    ...
                    <div class="option-grid">
                        <asp:Button ID="btnWalkIn" runat="server" Text="Walk-in" CssClass="option-btn selected" OnClick="btnDeliveryType_Click" CausesValidation="false" />
