<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="PotCor.Menu" %>
...
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* HERO SECTION - COMPACT ORANGE BANNER */
        .hero { 
            padding: 30px 40px; 
            text-align: center;
            background: #e8e8e8;
    ...
    <form id="form1" runat="server">
        ...
        <div class="hero">
            <div class="hero-banner">
                <h1>MENU</h1>
                <p>For over 32 years, Potato Corner has been serving flavorful moments in the Philippines and across the globe. From fries of all sizes and everything in between, Potato Corner always brings a fresh cup of delight best shared together.</p>
            </div>
        </div>
