<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembershipReceipt.aspx.cs" Inherits="PotCor.MembershipReceipt" %>
                ...
                <div class="member-info">
                    ...
                    <div class="member-details">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value"><asp:Label ID="lblAddress" runat="server"></asp:Label></div>
                        </div>
                        <div class="detail-row">
